...
- Data Snapshot (Statistics and raw data overview).
- Genre Analysis (Visual distribution of movies by genre).
- Financial Insights (Revenue vs Rating correlations).
- Model Performance (Accuracy metrics and feature importance).**

### **User Interface with Streamlit:**
**Provides a user-friendly interface built with Streamlit.
- Sidebar navigation for easy switching between Prediction and Analysis.
- Interactive Plotly charts and Seaborn heatmaps.
- Metric cards for quick results display.**
